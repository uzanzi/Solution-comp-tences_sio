<?php 
   ...
   // si la session existe pas soit si l'on est pas connecté on redirige
    ...
    $req2 = $bdd->prepare('SELECT * FROM ITEM_COMPETENCES');
    $req2->execute();
    $itemCompetences = $req2->fetchAll();
?>
<!doctype html>
<html lang="en">
  <head>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="#">Compétences SIO</a>
    ...
    <div class="container">
        <div class="col-md-12">
            ...
            <div class="text-center">
                <h1 class="p-3">Bonjour <?php echo $data['pseudo']; ?> !</h1>
                <hr/>
                <form action="#" method="post"></form>
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><input type="checkbox" name="acquis<?= $itemCompetence ?>"></td>
                                <td><?= $key[0] ?></td>
                                <td><?= $key[1] ?></td>
                                <td><?= $key[2] ?></td>
                            </tr>
                    ...
                    <button type="submit" class="btn btn-success btn-lg mb-4">Enregistrer mes acquis</button>
                </form>
